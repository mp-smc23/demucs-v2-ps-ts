...
# mll loss funcitons :
    ...
    parser.add_argument("--wandb_on",action="store_true", help="activate wandb logging. 0 for off, 1 for on. Default: off.")
    parser.add_argument("--comp_factor", type=float, default=1, help="Compression factor for ccmse. Default: 1 / no comp. cf > 1 = expansion, cf < 1 = compression.")
    parser.add_argument("--alpha", type=float, default=0.5, help="Alpha for ccmse (weighing of phase vs magnitude) (alpha = 1 -> magnitude loss = 100 %). Default = 0.5")
    parser.add_argument("--gradient_clip", type=float, default=100, help="choose the max norm for the gradient")
