...
srun --output="${outfile}" --error="${errfile}" singularity exec --nv ./../demucs.sif python3 -m demucs -b 4 -e 150 --mse --repeat 1 --no_augment --wav /ceph/home/student.aau.dk/xg64zo/smc10/res --musdb /ceph/home/student.aau.dk/xg64zo/smc10/res
