...
srun --output="${outfile}" --error="${errfile}" singularity exec --nv ./demucs.sif python3 run.py -b 128 -e 120 --SISDR --repeat 1 --repitch 0.5 --resample --audio_channels 1 --wav /ceph/home/student.aau.dk/xg64zo/smc10/mad --musdb /ceph/home/student.aau.dk/xg64zo/smc10/old_convs/noaug
