...
srun --output="${outfile}" --error="${errfile}" singularity exec --nv ./../demucs.sif python3 run.py -b 16 -e 1 --PITSISDR --repeat 1 --wav /ceph/home/student.aau.dk/xg64zo/smc10/mads --musdb /ceph/home/student.aau.dk/xg64zo/smc10/mads
