...
srun --output="${outfile}" --error="${errfile}" singularity exec --nv ./../demucs_asteroid.sif python3 run.py -b 128 -e 1 --PITSISDR --repeat 1 --wav /ceph/home/student.aau.dk/xg64zo/smc10/mads --musdb /ceph/home/student.aau.dk/xg64zo/smc10/mads
